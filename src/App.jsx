...
export default function App() {
  ...
  const navItems = [
    ...
    { id: 'cheat', label: 'Kritik Bilgiler', icon: <FiZap />, desc: '54 bölüm' },
            ...
            {currentView === 'settings' && (
              <div className="settings-view">
                ...
                <div className="settings-section glass-panel">
                  ...
                  <button className="settings-btn" onClick={() => { if (confirm('Quiz istatistikleri sıfırlansın mı?')) { localStorage.removeItem('ebeas_stats'); localStorage.removeItem('ebeas_answered_qs'); localStorage.removeItem('ebeas_hide_solved'); setStats({ solved: 0, correct: 0, savedMistakes: 0 }); alert('Quiz istatistikleri sıfırlandı!'); } }}><FiRefreshCw /> Quiz İstatistiklerini Sıfırla</button>
